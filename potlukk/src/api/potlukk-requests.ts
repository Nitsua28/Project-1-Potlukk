import { CreateUserForm, LukkerUserInfo, PotlukkCreationInput, Potlukk } from "../reducers/potlukk-reducer";
...
export async function createPotlukk(form: PotlukkCreationInput):Promise<Potlukk>{
